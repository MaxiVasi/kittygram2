...
class CatSerializer(serializers.ModelSerializer):
    ...
    # Переопределили поле только для чтения можно сделать в Meta тоже самое.
    ...
    # Проверка возраста котика. Валидация по полю birth_year должна
    # называться validate_birth_year.
    ...
    # Цвет котика и его имя не должны совпадать.
